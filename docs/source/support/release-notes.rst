...
- Introducing "flexible controllers": there's now a new way to specify choices, which allows you to pass the controller in as a parameter. For more information, see :doc:`/daml/reference/choices`.
